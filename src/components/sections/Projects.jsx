        ...
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition">
              ...
              <p className="text-gray-400 mb-4">
                JobScibe is a modern, AI-powered platform designed to help job
                seekers streamline their application process. It allows users to
                upload and optimise resumes, match keywords with job
                descriptions, and apply to jobs directly through the integrated
                Jobble API. The platform also includes an interactive About and
                Contact page, making it fully professional and responsive.
              </p>
              <div className="flex flex-wrap gap-2 mb-4">
                {[
                  "React",
