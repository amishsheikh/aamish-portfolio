...
export const Projects = () => {
  return (
    <section
      id="projects"
      className="min-h-screen flex items-center justify-center py-20 bg-gray-950"
    >
      <RevealOnScroll>
            ...
            {[
              {
                ...
                tech: ["React", "Node.js", "Express", "MongoDB", "OpenAI", "Clerk", "Tailwind"],
              ...
              },
              {
                ...
                tech: ["React", "Node.js", "Express", "MongoDB", "OpenAI", "JWT", "Tailwind"],
              ...
              <div
                key={project.title}
                className="p-6 rounded-2xl bg-gray-900 border border-white/20"
              >
                <img
                  src={project.img}
                  alt={`${project.title} screenshot`}
                  className="w-full h-48 object-cover rounded-xl mb-5 shadow-lg"
                  loading="lazy"
                />
                <h3 className="text-2xl font-bold mb-3 text-white">{project.title}</h3>
                <p className="text-gray-300 text-sm mb-6 leading-relaxed">{project.desc}</p>

                <div className="flex flex-wrap gap-2 mb-6">
                  {project.tech.map((tech) => (
                    <span
                      key={tech}
                      className="bg-white/10 text-blue-300 py-2 px-4 rounded-full text-xs font-medium"
                    >
                      {tech}
                    </span>
                  ))}
                ...
                <div className="flex justify-between items-center">
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="text-blue-400 font-semibold hover:text-cyan-300 transition"
                  >
                    Live Demo →
                  </a>
                  <a
